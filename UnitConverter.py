...
SINGLE_MODE_HINT = (
    "여러 치수: python UnitConverter.py --batch "
    "(한 줄씩 입력, 빈 줄로 변환 시작)"
)
BATCH_INTRO = "일괄 변환 모드 (--batch) — 치수를 입력하세요."
